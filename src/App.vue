        ...
        <section v-if="orders && orders.length" class="row">
          <div class="col-sm-4 col-sm-offset-4">
            <div class="card fluid">
              <ul class="orders">
                <li v-for="order in orders" :key="order.cocktail.id">
                  <div class="row">
                    <div class="col-sm-6">{{order.cocktail.name}} × {{order.amount}}</div>
                    <div class="col-sm-6 right">
                      <svg version="1.1" id="trash" @click="removeOrder(order)" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
